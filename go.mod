...
replace (
	...
	github.com/hashicorp/go-getter => github.com/hashicorp/go-getter v1.7.9
	github.com/hashicorp/go-retryablehttp v0.7.2 => github.com/hashicorp/go-retryablehttp v0.7.8
	github.com/moby/buildkit => github.com/moby/buildkit v0.12.5
	github.com/open-policy-agent/opa v0.46.1 => github.com/open-policy-agent/opa v1.4.0
	github.com/tencentcloud/tencentcloud-sdk-go v3.0.82+incompatible => github.com/tencentcloud/tencentcloud-sdk-go v1.0.191
	github.com/ulikunitz/xz v0.5.10 => github.com/ulikunitz/xz v0.5.15
